...
Location: /opt/miniconda3/envs/jupyterhubenv/lib/python3.7/site-packages/dockerspawner/dockerspawner.py
"""
...
class DockerSpawner(Spawner):
    ...
    # fix default port to 8888, used in the container - changed to random_port()
